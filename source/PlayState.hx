...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['How Bad Are You', 0.4], //From 20% to 39%
		['Dense', 0.5], //From 40% to 49%
		['Abnormal', 0.6], //From 50% to 59%
		['Dogcrap', 0.69], //From 60% to 68%
		['Could Be Better', 0.7], //69%
		['Expected', 0.8], //From 70% to 79%
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("scriptorcursive.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("scriptorcursive.otf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("scriptorcursive.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
